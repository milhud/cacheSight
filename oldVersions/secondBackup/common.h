...
// Cache anti-patterns
typedef enum {
    ANTIPATTERN_HOTSPOT_REUSE,
    ANTIPATTERN_THRASHING,
    ANTIPATTERN_FALSE_SHARING,
    ANTIPATTERN_IRREGULAR_GATHER_SCATTER,
    ANTIPATTERN_UNCOALESCED_ACCESS,
    ANTIPATTERN_LOOP_CARRIED_DEP,
    ANTIPATTERN_INSTRUCTION_OVERFLOW,
    ANTIPATTERN_DEAD_STORES,
    ANTIPATTERN_HIGH_ASSOCIATIVITY_PRESSURE,
    ANTIPATTERN_STREAMING_EVICTION,
    ANTIPATTERN_STACK_OVERFLOW,
    ANTIPATTERN_BANK_CONFLICTS
} cache_antipattern_t;
