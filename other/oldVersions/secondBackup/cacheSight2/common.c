...
const char* access_pattern_to_string(access_pattern_t pattern) {
    switch (pattern) {
        ...
        case PATTERN_GATHER_SCATTER: return "GATHER_SCATTER";
        case PATTERN_LOOP_CARRIED_DEP: return "LOOP_CARRIED_DEP";
        case PATTERN_NESTED_LOOP: return "NESTED_LOOP";
        case PATTERN_INDIRECT_ACCESS: return "INDIRECT_ACCESS";
...
const char* cache_antipattern_to_string(cache_antipattern_t pattern) {
    switch (pattern) {
        case ANTIPATTERN_HOTSPOT_REUSE: return "HOTSPOT_REUSE";
        case ANTIPATTERN_THRASHING: return "THRASHING";
        case ANTIPATTERN_FALSE_SHARING: return "FALSE_SHARING";
        case ANTIPATTERN_IRREGULAR_GATHER_SCATTER: return "IRREGULAR_GATHER_SCATTER";
        case ANTIPATTERN_UNCOALESCED_ACCESS: return "UNCOALESCED_ACCESS";
        case ANTIPATTERN_LOOP_CARRIED_DEP: return "LOOP_CARRIED_DEP";
        case ANTIPATTERN_INSTRUCTION_OVERFLOW: return "INSTRUCTION_OVERFLOW";
        case ANTIPATTERN_DEAD_STORES: return "DEAD_STORES";
        case ANTIPATTERN_HIGH_ASSOCIATIVITY_PRESSURE: return "HIGH_ASSOCIATIVITY_PRESSURE";
        case ANTIPATTERN_STREAMING_EVICTION: return "STREAMING_EVICTION";
        case ANTIPATTERN_STACK_OVERFLOW: return "STACK_OVERFLOW";
        case ANTIPATTERN_BANK_CONFLICTS: return "BANK_CONFLICTS";
        default: return "UNKNOWN";
    }
}
